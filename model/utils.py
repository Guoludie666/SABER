...
from model.test import(
    ...
    BertPrefixForNextSentencePrediction,
)
...
PREFIX_MODELS = {
    "bert": {
        ...
        TaskType.MaskedLM:BertPrefixForMaskedLM,
        TaskType.NextSentencePrediction:BertPrefixForNextSentencePrediction,
    },
    "roberta": {
