...
def save_pk(embeddings_file,keys):
    ...
    if biastype=='gender':
        ...
        with open("data/gpt_data/race/generate_race1.txt", "r", encoding='utf8') as f1:
            attribute0_lines=f1.readlines()[:]
        with open("data/gpt_data/race/race1.txt", "r", encoding='utf8') as f1_:
            attribute0mask_lines=f1_.readlines()[:]
        with open("data/gpt_data/race/generate_race2.txt", "r", encoding='utf8') as f2:
            attribute1_lines=f2.readlines()[:]
        with open("data/gpt_data/race/race2.txt", "r", encoding='utf8') as f2_:
            attribute1mask_lines=f2_.readlines()[:]
    elif biastype=='religion':
        with open("data/gpt_data/religion/generate_christianity.txt", "r", encoding='utf8') as f1:
            attribute0_lines=f1.readlines()[:]
        with open("data/gpt_data/religion/christianity.txt", "r", encoding='utf8') as f1_:
            attribute0mask_lines=f1_.readlines()[:]
        with open("data/gpt_data/religion/generate_islam.txt", "r", encoding='utf8') as f2:
            attribute1_lines=f2.readlines()[:]
        with open("data/gpt_data/religion/islam.txt", "r", encoding='utf8') as f2_:
            attribute1mask_lines=f2_.readlines()[:]
        with open("data/gpt_data/religion/generate_jedaism.txt", "r", encoding='utf8') as f3:
            attribute2_lines=f3.readlines()[:]
        with open("data/gpt_data/religion/jedaism.txt", "r", encoding='utf8') as f3_:
            attribute2mask_lines=f3_.readlines()[:]
    for i in XT_idx:
        # print(i,NT_MASK[i])
...
if __name__ == "__main__":
    ...
    if args.debias_type=='gender':
        ...
        gpt_sentences_file='data/gpt_data/religion/generate_christianity.txt'
        keys=['attribute0','attribute1','attribute2']
